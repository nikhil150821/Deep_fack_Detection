...
You can find the list of requirements in [requirements.txt](https://github.com/nikhil150821/Deep_fack_Detection/blob/main/Django%20Application/requirements.txt). Main requirements are listed below:
